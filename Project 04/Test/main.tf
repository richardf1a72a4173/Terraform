...
provider "azurerm" {
  subscription_id = "00000000-0000-0000-0000-000000000000" #Pre-Production
  features {}
}

locals {
  rg_location = "eastus2"
  rg_name     = "rg-project04-t-001"

  df_name       = "df-project04-t-001"
  mssql_name    = "azus-sql-project04-t-001"
  mssql_dbname  = "sql-project04-t-001"
  logic_appname = "la-project04-t-001"
  sa_name       = "saproject04t001"
  asp_name      = "asp-project04-t-001"

  tags = {
    "Active Directory" = "n/a"
    "Application Name" = "project04 - Test"
    Confidentiality    = "n/a"
    "Cost Centre"      = ""
    Environment        = "Test"
...
resource "azurerm_mssql_server" "rg" {
  ...
  azuread_administrator {
    ...
    login_username              = "JMDev.London@example.tld"
