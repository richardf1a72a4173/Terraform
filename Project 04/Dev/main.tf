...
provider "azurerm" {
  subscription_id = "00000000-0000-0000-0000-000000000000" #Dev-Test
  features {}
}

locals {
  rg_location = "eastus2"
  rg_name     = "rg-project04-d-001"

  df_name       = "df-project04-d-001"
  mssql_name    = "azus-sql-project04-d-001"
  mssql_dbname  = "sql-project04-d-001"
  logic_appname = "la-project04-d-001"
  sa_name       = "saproject04d001"
  asp_name      = "asp-project04-d-001"

  tags = {
    "Active Directory" = "n/a"
    "Application Name" = "project04 - Dev"
    Confidentiality    = "n/a"
    "Cost Centre"      = ""
    Environment        = "Dev"
